...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PA0     ------> ADC1_INP16
    */
    GPIO_InitStruct.Pin = Ia_adc_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(Ia_adc_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END ADC2_MspInit 0 */
    ...
    PA3     ------> ADC2_INP15
    */
    GPIO_InitStruct.Pin = Ib_adc_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(Ib_adc_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA0     ------> ADC1_INP16
    */
    HAL_GPIO_DeInit(Ia_adc_GPIO_Port, Ia_adc_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PA3     ------> ADC2_INP15
    */
    HAL_GPIO_DeInit(Ib_adc_GPIO_Port, Ib_adc_Pin);
